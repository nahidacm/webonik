...
class Sm_Slideshow_Helper_Data extends Mage_Core_Helper_Abstract {
	...
	function get($attributes=array())
	{
		...
		$module_setting				= Mage::getStoreConfig("slideshow_cfg/module_setting");
		$source_setting 			= Mage::getStoreConfig("slideshow_cfg/source_setting");
		$product_display_setting 	= Mage::getStoreConfig("slideshow_cfg/product_display_setting");
		$effect_setting 			= Mage::getStoreConfig("slideshow_cfg/effect_setting");
